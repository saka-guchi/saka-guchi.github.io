...
- **グラフ**: 「学習効果の持続期間に合わせた出題方法」の分布表示。
  ...
  - レベル定義：Lv.0(未学習)、Lv.1(数時間)、Lv.2(1日)、Lv.3(3日)、Lv.4(1週)、Lv.5(1ヶ月)。
...
- **Lv.0-1 (Standard)**: 英→日。Lv.1は学習後「数時間」で復習。
- **Lv.2 (Masked)**: 英→日 (英単語非表示)。
- **Lv.3 (Reverse)**: 日→英。
- **Lv.4+ (Fill-in)**: 例文穴埋め。

### 4.2 SRS (間隔反復) アルゴリズム
- **正解**: レベルアップ（最大5）、復習間隔の延長（最短0.5日）。
- **不正解**: レベルリセット（0）、復習間隔を0.5日（数時間）にリセット。
